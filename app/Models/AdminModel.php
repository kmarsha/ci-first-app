...
class AdminModel extends Model
{
    ...
    protected $allowedFields    = ['username', 'name', 'age'];
    ...
    public function getDataUser($username)
    {
        ...
        // $builder->select('*')->from('admins as adm')->where('adm.username', $username)->join('users as usr', 'usr.username = adm.username', 'inner');
        // return $builder->get();
